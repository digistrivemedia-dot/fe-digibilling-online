...
export default function TallyPortraitTemplate({ invoice, shopSettings }) {
    ...
    // Right-side invoice detail rows [label1, value1, label2, value2]
    ...
    return (
        <div className="invoice-print bg-white p-4 sm:p-8 rounded-lg shadow-sm border border-gray-200" style={{ fontFamily: 'Arial, sans-serif', fontSize: '11px', color: '#000' }}>
            ...
            {/* ── Invoice Type ─────────────────────────────── */}
            <div style={{ textAlign: 'center', fontSize: '13px', fontWeight: 'bold', border: B, borderTop: 'none', padding: '3px', marginBottom: '0' }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                    <tr style={{ backgroundColor: '#f0f0f0' }}>
                        ...
                        <th style={{ border: B, borderTop: 'none', padding: '3px 2px', textAlign: 'center', width: '8%', fontSize: '10px' }}>HSN/<br />SAC</th>
                ...
                <tbody>
                    ...
                    {!isBOS && invoice.taxType === 'CGST_SGST' && (
                        <>
                            <tr>
                                <td style={{ border: B, padding: '2px 2px' }}></td>
            ...
            {(hasBankDetails || shopSettings?.invQrCode) && (
                <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '4px' }}>
                    <tbody>
                        <tr>
                            <td style={{ border: B, padding: '5px', fontSize: '10px', width: shopSettings?.invQrCode ? '45%' : '55%', verticalAlign: 'top' }}>
                            ...
                            {shopSettings?.invQrCode ? (
                                <td style={{ border: B, padding: '5px', fontSize: '10px', verticalAlign: 'top', textAlign: 'center', width: '25%' }}>
                            ...
                            <td style={{ border: B, padding: '5px', fontSize: '10px', verticalAlign: 'top', width: '30%' }}>
